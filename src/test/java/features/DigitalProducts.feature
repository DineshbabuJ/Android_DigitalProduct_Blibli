Feature: Purchase a digital product in Blibli
  Scenario: place an order and cancel the order of digital product
    ...
    When choose one nominal "Auto_switch_prepaid" from nominals Listed
    ...
    Then verifies emailfield reflects same email id entered "dineshbabu142004@gmail.com"
    When enters the password "Password@123" and clicks Login
